// Based on the 'ilm' typst template.
...
#let proposal(
  ...
  show raw: set text(font: ("Iosevka", "FiraCode Nerd Font Mono"), size: 9pt)
  ...
  page(
    align(
      ...
      block(width: 90%)[
        ...
        #text(1.6em, fill: gradient.linear(rgb("#155caa"), rgb("#276dc3"), angle: 180deg))[*_The R Project for Statistical Computing_*]

        #v-space
        #text(2em, fill: rgb("#e37401"))[Google Summer of Code Proposal]
